...
export default function LandingPages() {
  ...
  return (
    <div className="grid">
      <div className="landing-page">
        <div className="flex">
          <div>
            <div className="statement">
              ...
              <h1 className="font-red">mengelola usaha</h1>
              <h1>kamu!</h1>
            </div>
            <div className="grid-statement">
              ...
              <div className="button-pelajari">
                <LinktoDown to="toPelajari" smooth={true} duration={1000}>
                  <button className="button-landing-page-two">
                    Pelajari dahulu!
                  </button>
                </LinktoDown>
              </div>
        ...
        <div>
          <svg
            ...
            width="764.327"
            height="607.942"
            viewBox="0 0 764.327 607.942"
          >
            <g transform="translate(-50.568 -104.58)">
              <g transform="translate(50.568 245.964)">
                <rect
                  width="744.508"
                  height="30.544"
                  transform="translate(19.819 436.014)"
                  fill="#eb414f"
                />
                <rect
                  width="744.508"
              ...
              <g transform="translate(330.106 692.898)">
                <path
                  d="M665.334,421.266c0,4.582-104.842,8.285-234.157,8.285S197,425.848,197,421.266,301.842,413,431.176,413,665.334,416.7,665.334,421.266Z"
                  transform="translate(-197 -413)"
                  fill="#eb414f"
                />
                <path
                  d="M665.334,421.266c0,4.582-104.842,8.285-234.157,8.285S197,425.848,197,421.266,301.842,413,431.176,413,665.334,416.7,665.334,421.266Z"
              ...
              <g transform="translate(344.252 287.294)">
                <path
                  d="M343.718,378.39s11.454,48.947,6.433,57c-6.471,10.519-75.482,16.856-75.482,16.856H426.836s19.09-5.345,13.363-20.674c-4.448-11.874-25.733-53.185-25.733-53.185Z"
                  transform="translate(-140.544 -38.856)"
                  fill="#fff"
                  stroke="#2e353a"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M340.4,378.39s12.141,49.367,6.433,57-72.16,13.458-72.16,13.458H427.542s12.867-5.192,9.3-17.276-25.714-53.185-25.714-53.185Z"
                  transform="translate(-140.544 -38.856)"
                  fill="#fff"
                  stroke="#2e353a"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M379.783,378.39H309.15s7.178,29.246,7.884,46.2h85.9C395.895,408.285,379.783,378.39,379.783,378.39Z"
                  transform="translate(-109.202 -38.856)"
                  fill="#eb414f"
                />
                <rect
                  width="152.166"
                  height="3.15"
                  transform="translate(134.126 410.243)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M9.5,0H449.633a9.5,9.5,0,0,1,9.5,9.5V334.864a9.5,9.5,0,0,1-9.5,9.5H9.5a9.5,9.5,0,0,1-9.5-9.5V9.5A9.5,9.5,0,0,1,9.5,0Z"
                  transform="translate(10.824)"
                  fill="#eb414f"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeWidth="1"
                ...
                />
                <path
                  d="M204.41,352.87H663.542v37.321a16.188,16.188,0,0,1-16.188,16.188H220.6a16.188,16.188,0,0,1-16.188-16.188Z"
                  transform="translate(-204.41 -62.054)"
                  fill="#fff"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M0,0H412.954V243.282H0Z"
                  transform="translate(23.099 21.419)"
                  fill="#e5636e"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeWidth="1"
                />
                <path
                  d="M337.172,370.926a8.457,8.457,0,1,0-2.47,5.992,8.476,8.476,0,0,0,2.47-5.992Z"
                  transform="translate(-99.139 -53.345)"
                  fill="#2e353a"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="405.833"
                  height="21.323"
                  transform="translate(26.344 38.562)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M285.158,238.182,280.31,225.01h-62.1v207.6H624.043V238.182Z"
                  transform="translate(-191.866 -178.278)"
                  fill="#fff"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M371.3,428.585s2.615,6.319,17.028,8.514,111.619-9.182,111.619-9.182,6.109-1.527,6.548-4.582-15.73-12.008-45.644-15.73a172.249,172.249,0,0,0-77.1,8.743C365.19,423.125,371.3,428.585,371.3,428.585Z"
                  transform="translate(-53.584 -13.321)"
                  fill="#fff"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M479.017,412.45c-6.491,0-21.171.687-33.121,1.718s-31.747,8.533-42.666,12.275-28.329,2.749-28.329,2.749a38.509,38.509,0,0,0,9.278,2.482c14.413,2.176,111.619-9.182,111.619-9.182a13.363,13.363,0,0,0,5.727-3.054C495.358,414.97,484.324,412.45,479.017,412.45Z"
                  transform="translate(-49.435 -7.896)"
                  fill="#eb414f"
                />
                <path
                  d="M439.35,415a17.17,17.17,0,0,1,2.424,1.546"
                  transform="translate(9.149 -5.578)"
                  fill="none"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M376.45,430.048a76.819,76.819,0,0,0,29.685-5.021,179.656,179.656,0,0,1,63-12.466c12.542-.1,20.216,1.623,24.817,3.36"
                  transform="translate(-48.026 -7.798)"
                  fill="none"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <g transform="translate(103.909 105.08)">
                <path
                  d="M478.948,285.05H352.42v77.009H478.356"
                  transform="translate(170.473 58.512)"
                  fill="none"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="126.528"
                  transform="translate(523.466 365.515)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="126.528"
                  transform="translate(523.466 387.411)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="126.528"
                  transform="translate(523.466 409.308)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 344.077)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 354.92)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 365.783)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 376.645)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 387.488)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 398.35)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 409.212)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="5.192"
                  transform="translate(514.226 420.055)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="5.822"
                  height="45.873"
                  transform="translate(527.493 374.392)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="5.822"
                  height="67.827"
                  transform="translate(537.821 352.439)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="5.822"
                  height="45.873"
                  transform="translate(548.168 374.392)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="5.822"
                  height="60.725"
                  transform="translate(571.419 359.54)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M0,0H5.822V51.676H0Z"
                  transform="translate(581.747 368.589)"
                  fill="#eb414f"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeWidth="1"
                ...
                <rect
                  width="5.822"
                  height="25.848"
                  transform="translate(592.094 394.417)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="5.822"
                  height="45.873"
                  transform="translate(615.345 374.392)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M0,0H5.822V67.827H0Z"
                  transform="translate(625.673 352.439)"
                  fill="#eb414f"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeWidth="1"
                ...
                <rect
                  width="5.822"
                  height="45.873"
                  transform="translate(636.02 374.392)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M333.18,376.157l64.562,48.317V357.01L333.18,105.08Z"
                  transform="translate(152.984 -105.08)"
                  fill="#eb414f"
                  stroke="#fff"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M629.236,295.4H419.247L78.51,247.08H564.674Z"
                  transform="translate(-78.51 23.997)"
                  fill="#eb414f"
                  stroke="#fff"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="92.911"
                  transform="translate(18.746 12.676)"
                  strokeWidth="2"
                  stroke="#fff"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M332.772,114.156a6.357,6.357,0,1,0-1.855,4.507,6.376,6.376,0,0,0,1.855-4.507Z"
                  transform="translate(141.021 -102.626)"
                  fill="#fff"
                />
                <path
                  d="M318.484,114.138a6.357,6.357,0,1,0-1.855,4.507,6.357,6.357,0,0,0,1.855-4.507Z"
                  transform="translate(128.068 -102.608)"
                  fill="#fff"
                />
                <rect
                  width="486.164"
                  height="244.351"
                  transform="translate(0 26.726)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M525.4,132.42H96.51V328.4H524.125"
                  transform="translate(-62.148 -80.228)"
                  fill="none"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="428.875"
                  transform="translate(35.641 108.049)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="428.875"
                  transform="translate(35.641 163.792)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x2="428.875"
                  transform="translate(35.641 219.534)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 53.452)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 81.094)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 108.736)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 136.359)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 164.002)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 191.625)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 219.267)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <line
                  x1="11.454"
                  transform="translate(15.272 246.909)"
                  strokeWidth="0.5"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M98.18,171.737s37.531,1.642,45.167-3.436,17.83-15.272,24.187-14.012a212.462,212.462,0,0,1,20.369,6.376s15.272-8.915,19.09-8.915,16.532,6.357,26.726,6.357h29.265l11.454,8.915,21.629-6.357,24.187,10.175,15.272-2.539,21.629,11.454h10.194l20.35,8.9h26.726l15.272,8.915,24.187,1.279,19.09,19.09,15.272-2.558,16.551,6.376,15.272-1.279"
                  transform="translate(-60.63 -62.657)"
                  fill="none"
                  stroke="#eb414f"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M97.84,186.357h47.095l28,3.818,22.908,1.279,20.35,13.993,29.284-8.915L281.1,209.265l39.459-6.357,13.993,6.357,31.823-35.641H398.2l19.09-20.35,20.35,8.9,12.733-11.454,16.551,8.915L477.1,146.9l6.357,1.279,16.551-5.1,7.636,5.1,12.733-2.539"
                  transform="translate(-60.939 -70.538)"
                  fill="none"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M98.51,251.678h49.634l38.18-21.629,28,12.733h20.35l10.194,3.818,22.908-11.454,30.544-19.09L308.5,230.049l19.09-2.539,10.175,2.539,25.466,1.279,27.986-22.908,14.012,16.532,17.811-1.26,10.175,6.357,15.272-3.818,20.369,7.636,28-3.818,15.272,2.539,8.9-2.539"
                  transform="translate(-60.33 -11.144)"
                  fill="none"
                  stroke="#eb414f"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M257.67,256.42l113.261,48.3v85.275L257.67,513.485Z"
                  transform="translate(84.346 32.487)"
                  fill="#eb414f"
                  stroke="#fff"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="250.384"
                  height="244.351"
                  transform="translate(91.632 288.907)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <rect
                  width="250.384"
                  height="230.358"
                  transform="translate(91.632 315.633)"
                  strokeWidth="1"
                  stroke="#2e353a"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M238.421,364.275l-99.268-.1a96.156,96.156,0,0,1,30.353-71.339Z"
                  transform="translate(-23.392 65.593)"
                  stroke="#fff"
                  strokeMiterlimit="10"
                  strokeWidth="1"
                />
                <path
                  d="M238.393,330.305l-25.771,95.812a98.027,98.027,0,0,1-73.439-95.908Z"
                  transform="translate(-23.364 99.562)"
                  stroke="#fff"
                  strokeMiterlimit="10"
                  strokeWidth="1"
                />
                <path
                  d="M205.8,373.416l46.675-87.566A99.268,99.268,0,0,1,179.93,469.228Z"
                  transform="translate(13.68 59.239)"
                  fill="#eb414f"
                  stroke="#fff"
                  strokeMiterlimit="10"
                  strokeWidth="1"
                />
                <path
                  d="M193.577,377.546l-5.1-99.1A94.475,94.475,0,0,1,240.252,289.9Z"
                  transform="translate(21.452 52.321)"
                  stroke="#fff"
                  strokeMiterlimit="10"
                  strokeWidth="1"
                />
                <path
                  d="M223.937,377.446,155.08,306.011a94.075,94.075,0,0,1,63.76-27.661Z"
                  transform="translate(-8.908 52.422)"
                  stroke="#fff"
                  strokeMiterlimit="10"
                  strokeWidth="1"
                />
                <path
                  d="M258.384,266.747a6.357,6.357,0,1,0-6.357,6.357,6.357,6.357,0,0,0,6.357-6.357Z"
                  transform="translate(73.438 36.096)"
                  fill="#fff"
                />
                <path
                  d="M244.142,266.765a6.376,6.376,0,1,0-6.376,6.357,6.376,6.376,0,0,0,6.376-6.357Z"
                  transform="translate(60.457 36.078)"
                  fill="#fff"
                />
                <path
                  d="M0,0H250.384V29.532H0Z"
                  transform="translate(91.632 315.633)"
                  fill="#eb414f"
                  stroke="#fff"
                  strokeLinecap="round"
      ...
      <div className="grid-berlangganan">
        <h1 id="toPelajari">Daftar sekarang dan nikmati fiturnya!</h1>
          ...
          <div className="card">
            <div className="container">
              ...
              <div className="card-flex">
                <p>Rp</p>
                <p className="card-harga">
                  {cardOne.product_name
                    ? cardOne.product_name.slice(5, 11)
                    : ""}
                </p>
                <p className="card-pcs">/ pcs</p>
              </div>
              <div className="card-desc">
                <svg
                  ...
                  width="54.119"
                  height="54.119"
                  viewBox="0 0 54.119 54.119"
                >
                  <path
                    d="M0,0H54.119V54.119H0Z"
                    transform="translate(0 0)"
                    fill="none"
                  />
                  <path
                    d="M24.549,2A22.549,22.549,0,1,0,47.1,24.549,22.558,22.558,0,0,0,24.549,2ZM20.04,35.824,8.765,24.549l3.179-3.179,8.1,8.073L37.155,12.328l3.179,3.2Z"
                    transform="translate(2.51 2.51)"
                    fill="#eb414f"
                  />
                </svg>
                <p className="p-card-desc">
                  Pulsa {cardOne.product_opt}{" "}
                  {cardOne?.product_name?.slice(5, 11)}
                </p>
              </div>
              <div className="card-desc">
                ...
                <p className="p-card-desc">Re-charge {cardOne.product_cat}</p>
              </div>
              <div className="card-desc">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="p-card-desc">
                  Bonus nelfon 20m sesama {cardOne.product_opt}
                </p>
              </div>
              <div className="card-desc">
          ...
          <div className="card">
            ...
            <div className="container">
              ...
              <div className="card-flex">
                <p>Rp</p>
                <p className="card-harga">
                  {cardTwo.product_name
                    ? cardTwo.product_name.slice(5, 12)
                    : ""}
                </p>
                <p className="card-pcs">/ pcs</p>
              </div>
              ...
              <div className="card-desc">
                ...
                <p className="p-card-desc">Re-charge {cardTwo.product_cat}</p>
              </div>
              <div className="card-desc">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="p-card-desc">
                  Bonus nelfon 40m sesama {cardTwo.product_opt}
                </p>
              </div>
              <div className="card-desc">
                <button className="button-aku-mau">Aku mau!</button>
          ...
          <div className="card">
            <div className="container">
              ...
              <div className="card-flex">
                <p>Rp</p>
                <p className="card-harga">
                  {cardThree.product_name
                    ? cardThree?.product_name?.slice(5, 12)
                    : ""}
                </p>
                <p className="card-pcs">/ pcs</p>
              </div>
              ...
              <div className="card-desc">
                ...
                <p className="p-card-desc">Re-charge {cardThree.product_cat}</p>
              </div>
              <div className="card-desc">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="p-card-desc">
                  Bonus nelfon 60m sesama {cardThree.product_opt}
                </p>
              </div>
              <div className="card-desc">
                <button className="button-aku-mau">Aku mau!</button>
